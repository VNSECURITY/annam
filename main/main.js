...
app.on('ready', function () {
  ...
  createWindow(function () {
    ...
    if (process.argv && process.argv[2] && process.argv[2].toLowerCase() !== __dirname.toLowerCase() && process.argv[2].indexOf('://') !== -1) {
 ...
 *
 * Opens a new tab when all tabs are closed, and still open by clicking on the application dock icon
 */
      ...
      submenu: [
        {
          ...
          click: function () {
            openTabInWindow('https://github.com/')
          }
        },
        {
          label: 'Report a Bug',
        ...
        },
        {
          label: 'Take a Tour',
          click: function () {
            openTabInWindow('https://github.io/')
          }
        },
        {
